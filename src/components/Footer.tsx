...
const Footer = () => {
  return (
    <footer className="bg-rfid-blue text-white pt-12 pb-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold mb-4">QuickTapPay</h3>
            <p className="text-gray-300 mb-4">
              Making contactless payments simple, secure, and seamless.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><Link to="#" className="text-gray-300 hover:text-white">RFID Cards</Link></li>
              <li><Link to="#" className="text-gray-300 hover:text-white">Mobile Payments</Link></li>
              <li><Link to="#" className="text-gray-300 hover:text-white">Business Solutions</Link></li>
              <li><Link to="#" className="text-gray-300 hover:text-white">Development API</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              &copy; {new Date().getFullYear()} QuickTapPay. All rights reserved.
            </p>
            <div className="flex mt-4 md:mt-0 space-x-8">
              ...
              <div className="flex items-center text-gray-300">
                ...
                <span className="text-sm">RFID Technology</span>
              </div>
              <div className="flex items-center text-gray-300">
